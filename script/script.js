...
window.addEventListener('load', () => {
    ...
    setTimeout(function () {
        document.getElementsByClassName("carousel-img").style.opacity = "0.3"
        document.getElementsByClassName("carousel-img").style.width = "0.5"
    }, 500);
    setTimeout(function () {
        document.getElementsByClassName("carousel-img").style.opacity = "1"
        document.getElementsByClassName("carousel-img").style.width = "1"
    }, 500);
});
...
buttons=document.getElementsByClassName('carousel-img')
for(button in buttons){
    button.addEventListener("click",function(){
        element.addClassList.add('fade')
    });
}
